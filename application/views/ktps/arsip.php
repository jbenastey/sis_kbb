<div class="col-12">
	<div class="card">
		<div class="card-body">
			...
			<h4 class="card-title text-center">Arsip Surat Keterangan KTP Sementara</h4>
			...
			<table class="table table-bordered">
				...
				if ($value['ktps_disposisi'] == 'Setuju'):
				?>
				<tr>
					<td><?= $no ?></td>
					<td><?= $value['ktps_nomor'] ?></td>
					<td><?= $value['ktps_nama'] ?></td>
					<td><?= $value['ktps_tanggal_lahir'] ?></td>
