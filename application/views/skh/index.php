<div class="col-12">
	<div class="card">
		<div class="card-body">
			<h4 class="card-title">Surat Keterangan Kehilangan</h4>
			<div class="row">
				<?php
							...
							foreach ($skh as $key => $value):
								if ($this->session->userdata('session_level') == 'Pegawai'):
									...
									<tr>
										...
										<td><?= $value['skh_baranghilang'] ?></td>
										<td><?= $value['skh_keterangan'] ?></td>
										<td><?php
											if ($value['skh_disposisi'] == null):
												?>
												<div class="badge badge-warning">Tunggu</div>
											<?php
											elseif ($value['skh_disposisi'] == 'Setuju'):
												?>
										...
										<td><a href="<?=base_url('skh/lihat/'.$value['skh_id'])?>"
											   class="btn btn-small btn-primary"
											   title="Lihat"><i
													class="fa fa-eye"></i></a>
											<a href="<?= base_url('skh/edit/' . $value['skh_id']) ?>"
											   class="btn btn-small btn-success" title="Edit"><i
													class="fa fa-pencil"></i></a>
											<a href="<?= base_url('skh/hapus/'.$value['skh_id']) ?>"
										...
										<tr>
											...
											<td><a href="<?=base_url('skh/lihat/'.$value['skh_id'])?>"
												...
												if ($this->session->userdata('session_level') == 'Penghulu'):
													if ($value['skh_disposisi'] == null):
														?>
														<a href="<?= base_url('skh/setuju/' . $value['skh_id']) ?>"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Barang Hilang"
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url("skh/tolak_surat")?>" method="post">
				<div class="modal-body">
					<div class="form-group">
