...
<div class="col-12">
	<div class="card">
		<div class="card-header  d-print-none">
			...
			<div class="col-12">
				<a class="btn btn-secondary btn-sm" href="<?=base_url('skh/lihat/'.$skh['skh_id'])?>"><i class="fa fa-arrow-left"></i></a>
		...
		<div class="card-body">
			...
			<div class="row mt-2" style="margin-left: 0%;">
				<div class="col-12 ml-12">
					<h4 class="text-center">SURAT KETERANGAN KEHILANGAN</h4>
					<p class="text-center">No : <?=$skh['skh_nomor']?></p>
				</div>
			</div>
			...
			<div class="row mt-2" style="margin-left: 20%">
				<table>
					<tr>
						...
						<td><p>:</p></td>
						<td><p><?=$skh['skh_nama']?></p></td>
					</tr>
					<tr>
						<td><p>Tempat/Tgl lahir</p></td>
						<td><p>:</p></td>
						<td><p><?=$skh['skh_tempat_lahir']?>, <?=$skh['skh_tanggal_lahir']?></p></td>
					</tr>
					<tr>
						<td><p>Agama</p></td>
						<td><p>:</p></td>
						<td><p><?=$skh['skh_agama']?></p></td>
					</tr>
					<tr>
						<td><p>Jenis Kelamin</p></td>
						<td><p>:</p></td>
						<td><p><?=$skh['skh_jk']?></p></td>
					</tr>
					<tr>
						<td><p>Pekerjaan</p></td>
						<td><p>:</p></td>
						<td><p><?=$skh['skh_kerja']?></p></td>
					</tr>
					<tr>
						<td><p>No. NIK KTP</p></td>
						<td><p>:</p></td>
						<td><p><?=$skh['skh_nik']?></p></td>
					</tr>
					<tr>
						<td><p>Alamat</p></td>
						<td><p>:</p></td>
						<td><p><?=$skh['skh_alamat']?></p></td>
					</tr>
				</table>
			</div>
			...
			<div class="row mt-3" style="margin-left: 10%;">
				<div class="col-10 ml-10">
					<p class="text-justify"><span class="ml-5"></span>Nama tersebut di atas datang melapor kepada kami atas kehilangan sebagai berikut:</p>
					<p class="text-justify"><span class="ml-5"></span>1. <?=$skh['skh_baranghilang']?></p>
					<p class="text-justify"><span class="ml-5"></span><?=$skh['skh_keterangan']?></p>
				</div>
			</div>
			<div class="row" style="margin-left: 10%;">
				<div class="col-10 ml-10">
					<p class="text-justify"><span class="ml-5"></span>Adapun surat keterangan ini kami berikan kepada yang bersangkutan untuk mendapatkan surat keterangan dari instansi selanjutnya.</p>
				</div>
			</div>
			<div class="row" style="margin-left: 10%;">
				<div class="col-10 ml-10">
