								...
								if ($this->session->userdata('session_level') == 'Pegawai'):
									...
									<tr>
										...
										<td><?php
											...
											<?php
											elseif ($value['sku_disposisi'] == 'Setuju'):
												?>
										...
										<td><a href="<?=base_url('sku/lihat/'.$value['sku_id'])?>"
											...
											<a href="<?= base_url('sku/hapus/'.$value['sku_id']) ?>"
										...
										<tr>
											...
											<td><a href="<?=base_url('sku/lihat/'.$value['sku_id'])?>"
												...
												if ($this->session->userdata('session_level') == 'Penghulu'):
													if ($value['sku_disposisi'] == null):
														?>
														<a href="<?= base_url('sku/setuju/' . $value['sku_id']) ?>"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nomor Register"
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url("sku/tolak_surat")?>" method="post">
				<div class="modal-body">
					<div class="form-group">
