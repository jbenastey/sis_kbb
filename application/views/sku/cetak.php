...
<div class="col-12">
	<div class="card">
		<div class="card-header  d-print-none">
			...
			<div class="col-12">
				<a class="btn btn-secondary btn-sm" href="<?=base_url('sku/lihat/'.$sku['sku_id'])?>"><i class="fa fa-arrow-left"></i></a>
		...
		<div class="card-body">
			...
			<div class="row mt-2" style="margin-left: 0%;">
				<div class="col-12 ml-12">
					<h4 class="text-center">SURAT KETERANGAN USAHA</h4>
					<p class="text-center">No : <?=$sku['sku_nomor']?></p>
				</div>
			</div>
			...
			<div class="row mt-2" style="margin-left: 20%">
				<table>
					<tr>
						...
						<td><p>:</p></td>
						<td><p><?=$sku['sku_nama']?></p></td>
					</tr>
					<tr>
						<td><p>Tempat/Tgl lahir</p></td>
						<td><p>:</p></td>
						<td><p><?=$sku['sku_tempat_lahir']?>, <?=$sku['sku_tanggal_lahir']?></p></td>
					</tr>
					<tr>
						<td><p>Warganegara</p></td>
						<td><p>:</p></td>
						<td><p><?=$sku['sku_wni']?></p></td>
					</tr>
					<tr>
						<td><p>Agama</p></td>
						<td><p>:</p></td>
						<td><p><?=$sku['sku_agama']?></p></td>
					</tr>
					<tr>
						<td><p>Jenis Kelamin</p></td>
						<td><p>:</p></td>
						<td><p><?=$sku['sku_jk']?></p></td>
					</tr>
					<tr>
						<td><p>Pekerjaan</p></td>
						<td><p>:</p></td>
						<td><p><?=$sku['sku_kerja']?></p></td>
					</tr>
					<tr>
						<td><p>No. NIK KTP</p></td>
						<td><p>:</p></td>
						<td><p><?=$sku['sku_nik']?></p></td>
					</tr>
					<tr>
						<td><p>Alamat</p></td>
						<td><p>:</p></td>
						<td><p><?=$sku['sku_alamat']?></p></td>
					</tr>
				</table>
			</div>
			...
			<div class="row mt-3" style="margin-left: 10%;">
				<div class="col-10 ml-10">
					<p class="text-justify"><span class="ml-5"></span>Nama tersebut di atas adalah benar penduduk kami yang tinggal di lingkungan RT/RW 021/006 Dusun Balam Timur, Kepenghuluan Bangko Bangko, Kecamatan Bangko Pusako, Kabupaten Rokan Hilir, Provinsi Riau, Dan Benar menurut sepengetahuan kami nama di atas memiliki usaha.............................................................Dengan Nomor Register...............................................Surat keterangan ini berlaku satu bulan sejak tanggal pengeluarannya . Dan berakhir pada tanggal.............................</p>
				</div>
			</div>
