				...
				<div class="col-12">
					<div class="table-responsive">
						<table id="order-listing" class="table">
							...
							<?php
							$no = 1;
							foreach ($skpn as $key => $value):
								if ($this->session->userdata('session_level') == 'Pegawai'):
									?>
									<tr>
										<td><?= $no ?></td>
										<td><?= $value['skpn_nomor'] ?></td>
										<td><?= $value['skpn_nama'] ?></td>
										<td><?= $value['skpn_tanggal_lahir'] ?></td>
										<td><?= $value['skpn_tempat_lahir'] ?></td>
										<td><?= $value['skpn_wni'] ?></td>
										<td><?= $value['skpn_jk'] ?></td>
										<td><?php
											...
											<?php
											elseif ($value['skpn_disposisi'] == 'Setuju'):
												?>
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url("skpn/tolak_surat")?>" method="post">
				<div class="modal-body">
					<div class="form-group">
