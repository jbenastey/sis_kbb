							...
							foreach ($sktk as $key => $value):
								if ($this->session->userdata('session_level') == 'Pegawai'):
									...
									<tr>
										...
										<td><?= $value['sktk_jk'] ?></td>
										<td><?php
											if ($value['sktk_disposisi'] == null):
												?>
												<div class="badge badge-warning">Tunggu</div>
											<?php
											elseif ($value['sktk_disposisi'] == 'Setuju'):
												?>
										...
										<td><a href="<?=base_url('sktk/lihat/'.$value['sktk_id'])?>"
											...
											if ($value['sktk_disposisi'] == null):
											?>
											<a href="<?= base_url('sktk/edit/' . $value['sktk_id']) ?>"
											   class="btn btn-small btn-success" title="Edit"><i
													class="fa fa-pencil"></i>Edit</a>
											<a href="<?= base_url('sktk/hapus/'.$value['sktk_id']) ?>"
										...
										<tr>
											...
											<td><a href="<?=base_url('sktk/lihat/'.$value['sktk_id'])?>"
												...
												if ($this->session->userdata('session_level') == 'Penghulu'):
													if ($value['sktk_disposisi'] == null):
														?>
														<a href="<?= base_url('sktk/setuju/' . $value['sktk_id']) ?>"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nama Bapak"
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url("sktk/tolak_surat")?>" method="post">
				<div class="modal-body">
					<div class="form-group">
