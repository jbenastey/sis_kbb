							...
							foreach ($spbpn as $key => $value):
								if ($this->session->userdata('session_level') == 'Pegawai'):
									...
									<tr>
										...
										<td><?= $value['spbpn_kerja'] ?></td>
										<td><?= $value['spbpn_nik'] ?></td>
										<td><?= $value['spbpn_alamat'] ?></td>
										<td><?php
											if ($value['spbpn_disposisi'] == null):
												?>
												<div class="badge badge-warning">Tunggu</div>
											<?php
											elseif ($value['spbpn_disposisi'] == 'Setuju'):
												?>
										...
										<td><a href="<?=base_url('spbpn/lihat/'.$value['spbpn_id'])?>"
											...
											<a href="<?= base_url('spbpn/hapus/'.$value['spbpn_id']) ?>"
										...
										<tr>
											...
											<td><a href="<?=base_url('spbpn/lihat/'.$value['spbpn_id'])?>"
												...
												if ($this->session->userdata('session_level') == 'Penghulu'):
													if ($value['spbpn_disposisi'] == null):
														?>
														<a href="<?= base_url('spbpn/setuju/' . $value['spbpn_id']) ?>"
...
<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url("spbpn/tolak_surat")?>" method="post">
				<div class="modal-body">
					<div class="form-group">
