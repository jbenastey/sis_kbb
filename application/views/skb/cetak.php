...
<div class="col-12">
	<div class="card">
		<div class="card-header  d-print-none">
			...
			<div class="col-12">
				<a class="btn btn-secondary btn-sm" href="<?=base_url('skb/lihat/'.$skb['skb_id'])?>"><i class="fa fa-arrow-left"></i></a>
		...
		<div class="card-body">
			...
			<div class="row mt-2" style="margin-left: 0%;">
				<div class="col-12 ml-12">
					<h4 class="text-center">SURAT KETERANGAN BERDOMISILI</h4>
					<p class="text-center">No : <?=$skb['skb_nomor']?></p>
				</div>
			</div>
			...
			<div class="row mt-2" style="margin-left: 20%">
				<table>
					<tr>
						...
						<td><p>:</p></td>
						<td><p><?=$skb['skb_nama']?></p></td>
					</tr>
					<tr>
						<td><p>Tempat/Tgl lahir</p></td>
						<td><p>:</p></td>
						<td><p><?=$skb['skb_tempat_lahir']?>, <?=$skb['skb_tanggal_lahir']?></p></td>
					</tr>
					<tr>
						<td><p>Warganegara</p></td>
						<td><p>:</p></td>
						<td><p><?=$skb['skb_wni']?></p></td>
					</tr>
					<tr>
						<td><p>Agama</p></td>
						<td><p>:</p></td>
						<td><p><?=$skb['skb_agama']?></p></td>
					</tr>
					<tr>
						<td><p>Jenis Kelamin</p></td>
						<td><p>:</p></td>
						<td><p><?=$skb['skb_jk']?></p></td>
					</tr>
					<tr>
						<td><p>Pekerjaan</p></td>
						<td><p>:</p></td>
						<td><p><?=$skb['skb_kerja']?></p></td>
					</tr>
					<tr>
						<td><p>Alamat</p></td>
						<td><p>:</p></td>
						<td><p><?=$skb['skb_alamat']?></p></td>
					</tr>
					<tr>
						<td><p>Jumlah Keluarga</p></td>
						<td><p>:</p></td>
						<td><p><?=$skb['skb_jumlahkeluarga']?></p></td>
					</tr>
				</table>
			</div>
			...
			<div class="row mt-3" style="margin-left: 10%;">
				<div class="col-10 ml-10">
					<p class="text-justify"><span class="ml-5"></span>Nama tersebut di atas adalah benar penduduk kami yang tinggal di <?=$skb['skb_alamat']?>, Dan benar nama tersebut diatas berdomisili di kepenghuluan Bangko Bakti.</p>
				</div>
			</div>
