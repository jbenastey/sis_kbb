...
<div class="col-12">
	<div class="card">
		<div class="card-header  d-print-none">
			...
			<div class="col-12">
				<a class="btn btn-secondary btn-sm" href="<?=base_url('skkn/lihat/'.$skkn['skkn_id'])?>"><i class="fa fa-arrow-left"></i></a>
		...
		<div class="card-body">
			...
			<div class="row mt-2" style="margin-left: 0%;">
				<div class="col-12 ml-12">
					<h4 class="text-center">SURAT KETERANGAN KEBENARAN NAMA</h4>
					<p class="text-center">No : <?=$skkn['skkn_nomor']?></p>
				</div>
			</div>
			...
			<div class="row mt-2" style="margin-left: 20%">
				<table>
					<tr>
						...
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_nama']?></p></td>
					</tr>
					<tr>
						<td><p>Tempat/Tgl lahir</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_tempat_lahir']?>, <?=$skkn['skkn_tanggal_lahir']?></p></td>
					</tr>
					<tr>
						<td><p>Warganegara</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_wni']?></p></td>
					</tr>
					<tr>
						<td><p>Agama</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_agama']?></p></td>
					</tr>
					<tr>
						<td><p>Jenis Kelamin</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_jk']?></p></td>
					</tr>
					<tr>
						<td><p>Status Perkawinan</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_status']?></p></td>
					</tr>
					<tr>
						<td><p>Pekerjaan</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_kerja']?></p></td>
					</tr>
					<tr>
						<td><p>No. NIK KTP</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_nik']?></p></td>
					</tr>
					<tr>
						<td><p>Alamat</p></td>
						<td><p>:</p></td>
						<td><p><?=$skkn['skkn_alamat']?></p></td>
					</tr>
				</table>
			</div>
			...
			<div class="row mt-3" style="margin-left: 10%;">
				<div class="col-10 ml-10">
					<p class="text-justify"><span class="ml-5"></span>Nama tersebut di atas adalah benar penduduk kami yang tinggal di <?=$skkn['skkn_alamat']?>, Dan benar nama yang ada di surat tanah <b><?=$skkn['skkn_nama']?></b> orang yang sama dengan yang ada di Kartu Tanda Penduduk(KTP).</p>
				</div>
			</div>
